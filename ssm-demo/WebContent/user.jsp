...
<script type="text/javascript">
	...
	function deleteUser(){
		...
		var strIds=[];
		for (var int = 0; int < selectedRows.length.length; int++) {
...
<body style="margin:1px">
	...
	<div id="tb">
        ...
        <div id="dlg" class="easyui-dialog" style="width:730px;height:280px;padding:10px 10px;" closed="true" buttons="#dlg-buttons">
